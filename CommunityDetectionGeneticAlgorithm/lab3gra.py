...
crtDir =  os.getcwd()
filePathD = os.path.join(crtDir, 'materiale', 'real', 'dolphins', 'dolphins.gml')

G = nx.read_gml(filePathD)
nG =nx.convert_node_labels_to_integers(G, first_label=0)

print(community_detection(nG))
